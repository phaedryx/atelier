...
final class AsyncSetupRerunTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        // Asks the resolver rather than re-implementing its search, which is
        // what this did while a configured path could override the list and had
        // to be cleared out of the way first. There is no setting now, so the
        // question and the answer are the same one.
        try XCTSkipIf(
