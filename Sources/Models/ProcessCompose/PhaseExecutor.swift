...
extension ProcessCompose {
    enum PhaseExecutor {
        ...
        ///   is the bug `ProcessCompose.PhaseEnvironment` exists to close.
        ...
        static func run(
            ...
            let socketPath = ProcessCompose.PhaseRunner.socketPath(for: workstreamID, phase: phase)
        ...
        private static func pollToCompletion(
            socketPath: String,
            presence: ProcessCompose.Config.NamespacePresence,
            deadline: Date,
        ...
        static func outcome(
            for phase: ProcessCompose.Phase,
            poll: PollResult,
