...
extension ProcessCompose {
    ...
    struct ProcessEntry: Decodable, Equatable, Identifiable {
        let name: String
    ...
    struct Client: ProcessCompose.Controlling {
        ...
        /// individual `read` looked healthy — which defeats `ProcessCompose.PhaseExecutor`'s
        ...
        private struct Envelope: Decodable {
            let data: [ProcessCompose.ProcessEntry]
        }

        static func decodeProcesses(_ data: Data) throws -> [ProcessCompose.ProcessEntry] {
            do {
        ...
        /// `processes()` never suspends. `ProcessCompose.PhaseExecutor` polls from a dedicated
        ...
        func processesSync() throws -> [ProcessCompose.ProcessEntry] {
