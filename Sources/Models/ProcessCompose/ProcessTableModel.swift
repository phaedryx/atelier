...
extension ProcessCompose {
    ...
    final class TableModel: ObservableObject {
        @Published private(set) var processes: [ProcessCompose.ProcessEntry] = []
        ...
        private let client: ProcessCompose.Controlling
        ...
        init(socketPath: String, client: ProcessCompose.Controlling? = nil) {
            self.socketPath = socketPath
            self.client = client ?? ProcessCompose.Client(socketPath: socketPath)
        }
